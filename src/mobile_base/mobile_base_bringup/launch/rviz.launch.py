...
def generate_launch_description():
	...
	xacro_path = os.path.join(get_package_share_directory('mobile_base_description'), 'urdf', 'the_bot.xacro')
	...
	rviz = Node(
		...
		name='rviz2',
		output='screen',
		arguments=['-d', os.path.join(get_package_share_directory('mobile_base_bringup'), 'rviz', 'entire_setup.rviz')]
	)
