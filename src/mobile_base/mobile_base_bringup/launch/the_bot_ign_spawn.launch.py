...
def generate_launch_description():
    ...
    #     join(the_bot_path, "urdf", "the_bot.xacro"),
    #     {"sim_gz": "true",
    ...
    robot_state_publisher = Node(
        ...
        parameters=[
                    ...
                    ['xacro ', join(the_bot_path, 'urdf/the_bot.xacro'),
        ...
        remappings=[
            ('/joint_states', 'the_bot/joint_states'),
        ]
    )
    ...
    gz_ros2_bridge = Node(
        ...
        remappings=[
            ('/world/default/model/the_bot/joint_state', 'the_bot/joint_states'),
            ('/odom', 'the_bot/odom'),
            ('/scan', 'the_bot/scan'),
            ('/kinect_camera', 'the_bot/kinect_camera'),
            ('/stereo_camera/left/image_raw', 'the_bot/stereo_camera/left/image_raw'),
            ('/stereo_camera/right/image_raw', 'the_bot/stereo_camera/right/image_raw'),
            ('/imu', 'the_bot/imu'),
            ('/cmd_vel', 'the_bot/cmd_vel'),
            ('kinect_camera/camera_info', 'the_bot/kinect_camera/camera_info'),
            ('stereo_camera/left/camera_info', 'the_bot/stereo_camera/left/camera_info'),
            ('stereo_camera/right/camera_info', 'the_bot/stereo_camera/right/camera_info'),
            ('/kinect_camera/points', 'the_bot/kinect_camera/points'),
        ]
    )
    ...
    transform_publisher = Node(
        ...
        arguments = ["--x", "0.0",
                    ...
                    "--child-frame-id", "the_bot/base_footprint/kinect_camera"]
    )
